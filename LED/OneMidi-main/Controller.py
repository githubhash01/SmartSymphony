...
class Controller:
    ...
    def __init__(self, LED, Microphone):
        ...
        self.notes = ["C5","C#5","D5","D#5","F5","F#5","G5","G#5","A#5","B5","C6"]
        self.dict = {31:"C5",
                         32:"C#5",
                         33:"D5",
                         34: "D#5",
    ...
    def run(self):
        ...
        while True:
            ...
            if note!= None and note!='end':
                ...
                #if note == self.dict[self.sequence[self.index]](ARYAN COMMENTED OUT):
                if note == self.notes[self.index]:
                    #if self.index == len(self.sequence):(ARYAN COMMENTED OUT)
