...
while True:
    ...
    print(val)
    time.sleep(0.1)
# Specify the port number; A0 port is number 0
"""
"""
microphone_port = 2
...
while True:
    try:
        # Read the microphone value from the A0 port
        sound_level = grovepi.analogRead(microphone_port)
        ...
        print("Error reading from the microphone")
